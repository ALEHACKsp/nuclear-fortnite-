...
// dm if you need help fixing :)
// dm if you need help fixing :)// dm if you need help fixing :)
...
bo
		if (*(UINT8*)(p1 + off) != *(UINT8*)(p2 + off))
			return false;
		off++;//nuclear source from 2018 leaked by Harvey#6998 , dm if you need help fixing :)
	}
	...
	while (true)
	{
		if (*(UINT8*)(ptr) == 0xFF && *(UINT8*)(ptr + 1) == 0x23)
			return ptr;
		ptr++;//nuclear source from 2018 leaked by Harvey#6998 , dm if you need help fixing :)
	}
...
struct UCanvas_K2_DrawText_Params
{
	...
	struct FLinearColor                                ShadowColor;                                              // (Parm, IsPl//
//╭╮╱╱╭━━━┳━━━┳╮╭━┳━━━┳━━━╮╭━━┳╮╱╱╭╮╭╮╱╭╮╱╱╱╱╱╱╱╱╱╱╱╱╱╱╭━━━┳━━━┳━━━┳━━━╮
//┃┃╱╱┃╭━━┫╭━╮┃┃┃╭┫╭━━┻╮╭╮┃┃╭╮┃╰╮╭╯┃┃┃╱┃┃╱╱╱╱╱╱╱╱╱╱╱╱╱╱┃╭━━┫╭━╮┃╭━╮┃╭━╮┃
//┃┃╱╱┃╰━━┫┃╱┃┃╰╯╯┃╰━━╮┃┃┃┃┃╰╯╰╮╰╯╭╯┃╰━╯┣━━┳━┳╮╭┳━━┳╮╱╭┫╰━━┫╰━╯┃╰━╯┃╰━╯┃
//┃┃╱╭┫╭━━┫╰━╯┃╭╮┃┃╭━━╯┃┃┃┃┃╭━╮┣╮╭╯╱┃╭━╮┃╭╮┃╭┫╰╯┃┃━┫┃╱┃┃╭━╮┣━━╮┣━━╮┃╭━╮┃
...
D3DMATRIX ToMatrixWithScale(const FVector& translation, const FVector& scale, const FQuat& //
//╭╮╱╱╭━━━┳━━━┳╮╭━┳━━━┳━━━╮╭━━┳╮╱╱╭╮╭╮╱╭╮╱╱╱╱╱╱╱╱╱╱╱╱╱╱╭━━━┳━━━┳━━━┳━━━╮
//┃┃╱╱┃╭━━┫╭━╮┃┃┃╭┫╭━━┻╮╭╮┃┃╭╮┃╰╮╭╯┃┃┃╱┃┃╱╱╱╱╱╱╱╱╱╱╱╱╱╱┃╭━━┫╭━╮┃╭━╮┃╭━╮┃
//┃┃╱╱┃╰━━┫┃╱┃┃╰╯╯┃╰━━╮┃┃┃┃┃╰╯╰╮╰╯╭╯┃╰━╯┣━━┳━┳╮╭┳━━┳╮╱╭┫╰━━┫╰━╯┃╰━╯┃╰━╯┃
//┃┃╱╭┫╭━━┫╰━╯┃╭╮┃┃╭━━╯┃┃┃┃┃╭━╮┣╮╭╯╱┃╭━╮┃╭╮┃╭┫╰╯┃┃━┫┃╱┃┃╭━╮┣━━╮┣━━╮┃╭━╮┃
...
//╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━━╯rot)
{
	D3DMATRIX m//nuclear source from 2018 leaked by Harvey#6998 , dm if you need help fixing :)
	m._41 = translation.x;
	m._42 = translation.y;
	m._43 = translation.z;
